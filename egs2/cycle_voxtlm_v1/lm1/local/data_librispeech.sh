...
data_dir_tts="${data_dir}/tts"
data_dir_text="${data_dir}/text"
data_dir_speech="${data_dir}/speech"
mkdir -p ${data_dir_asr}
mkdir -p ${data_dir_tts}
mkdir -p ${data_dir_text}
mkdir -p ${data_dir_speech}
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    # create asr data
    cp -r ${data_dir_asr}/train_clean_100 ${data_dir_asr}/${train_set}
    # dev
    cp -r ${data_dir_asr}/dev_clean ${data_dir_asr}/${train_dev}
    # test
    cp -r ${data_dir_asr}/test_clean ${data_dir_asr}/${train_eval}
    
    # create tts data
    cp -r ${data_dir_asr}/train_clean_100 ${data_dir_tts}/${train_set}
    # dev
    cp -r ${data_dir_asr}/dev_clean ${data_dir_tts}/${train_dev}
    # test
    cp -r ${data_dir_asr}/test_clean ${data_dir_tts}/${train_eval}
    
    # create unpaired text data
    cp -r ${data_dir_asr}/train_other_500 ${data_dir_text}/${train_set}

    # create unpaired speech data
    cp -r ${data_dir_asr}/train_clean_360 ${data_dir_speech}/${train_set}
